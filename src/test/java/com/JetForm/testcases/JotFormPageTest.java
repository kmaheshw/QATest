...
public class JotFormPageTest extends TestBase {
	...
	//@Test (priority = 0)
	@Test()
	public void AAAverifyHomePageTitleTest(){ //Method to verify home page title
	...
	//@Test (priority = 1)
	@Test()
	public void BBBEnterFormInformation(String fName,String lName,String emailId, String roomTypeEntry, String NoOfGuest,String ArrivalDate,String departureMonth,String departureDay, String departureYear,String flight,String specialRequest) throws AWTException{ //Method to verify home page title
	...
	//@Test (priority = 2)
	  @Test()
		public void CCCverifyTitleTest(){ //Method to verify home page title
		String homePageTitle = jotFormPage.verifyPageTitle();
		String message="Actual title is " + homePageTitle;
